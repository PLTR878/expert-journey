// ✅ Visionary Batch Scanner — v∞.47 (Ultra Fast + Stable + Full U.S. Market)
export default async function handler(req, res) {
  ...
  try {
    ...
    for (const s of symbols) {
      ...
      await new Promise((r) => setTimeout(r, 100)); // ✅ เร็ว + ปลอด block
    }
